...
class RecipeAPIv2TestMixin(RecipeMixin):
    ...
    def get_recipe_raw_data(self):
        return {
            ...
            'preparation_steps': 'This is the preparation step.'
        }
...
class RecipeAPIv2Test(test.APITestCase, RecipeAPIv2TestMixin):
    ...
    def test_recipe_api_list_loads_recipes_by_caregory_id(self):
        # Create categories
        ...
        # Change one recipe to the NOT wanted category, and this recipe should not be shown
        recipes[0].category = category_not_wanted
        recipes[0].save()

        # Action: get recupes by wanted category_id
    ...
    def test_recipe_api_list_logged_user_cant_update_a_recipe_owned_by_another_user(self):
        ...
        # This is the actual user of the recipe
        author = access_data.get('user')
        recipe.author = author
        recipe.save()
