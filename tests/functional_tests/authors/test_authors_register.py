...
class AuthorsRegisterTest(AuthorsBaseTest):
    ...
    def form_field_test_with_callback(self, callback):
        ...
        form.find_element(By.NAME, 'email').send_keys('test@example.com')
    ...
    def test_empty_username_error_message(self):
        def callback(form):
            username_name_field = self.get_by_placeholder(form, 'Your username')
    ...
    def test_invalid_email_error_message(self):
        def callback(form):
            email_name_field = self.get_by_placeholder(form, 'Your e-mail')
            email_name_field.send_keys('email@invalid.com')
    ...
    def test_passwords_do_not_match(self):
        def callback(form):
            ...
            password1.send_keys('P@assw0rd')
            password2.send_keys('P@assw0rd_Different')
    ...
    def test_user_valid_data_register_successfully(self):
        ...
        self.get_by_placeholder(form, 'Type your password').send_keys('P@assw0rd')
        self.get_by_placeholder(form, 'Repeat your password').send_keys('P@assw0rd')
